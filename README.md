# Scale OpenShift ingresscontroller using KEDA

This repo is an example of:

- Installing KEDA operator on your cluster
- Creating KEDA resources (triggerauthentication, scaledobject, etc)
...
1. Install KEDA from OperatorHub

In the OperatorHub locate and install KEDA.
...
A functioning KEDA setup will have 3 pods running:
...
a very simple deployment. The goal here is to ensure all the KEDA
pieces have been setup correctly.
